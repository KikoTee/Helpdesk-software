...
def main():
    ...
    ticket1 = Ticket("S123", "John Doe", "john@example.com", "Password Change request")
    ticket2 = Ticket("S456", "Jane Smith", "jane@example.com", "Network connectivity issue")
    ticket3 = Ticket("S789", "Alice Johnson", "alice@example.com", "Software installation problem")
    ticket4 = Ticket("S101", "Bob White", "bob@example.com", "Printer not working")
    ticket5 = Ticket("S202", "Emma Brown", "emma@example.com", "Email configuration issue")
